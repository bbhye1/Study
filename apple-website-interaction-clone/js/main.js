(() => {
            ...
            case 3:
                ...
                if (scrollRatio < values.rect1X[2].end) {
                    ...
                    objs.context.drawImage(
                        objs.images[1], 0, objs.canvas.height - blendHeight, objs.canvas.width, blendHeight, 0, objs.canvas.height - blendHeight, objs.canvas.width, blendHeight,
                    );
    ...
    function setCanvasImages() {
        ...
        for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
            imageEl = new Image();
            imageEl.src = `../video/001/IMG_${6726 + i}.jpg`;
            sceneInfo[0].objs.videoImages.push(imageEl);
        }

        let imageEl2;
        for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
            imageEl2 = new Image();
            imageEl2.src = `../video/002/IMG_${7027 + i}.jpg`;
            sceneInfo[2].objs.videoImages.push(imageEl2);
        }

        let imageEl3;
        for (let i = 0; i < sceneInfo[3].objs.imagesPath.length; i++) {
            imageEl3 = new Image();
            imageEl3.src = sceneInfo[3].objs.imagesPath[i];
